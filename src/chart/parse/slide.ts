...
import { beatSchema, sizeSchema } from './schemas'

export const parseChartSlides: ParseChart = (chart, entities) => {
...
const toNoteObject = (
  ...
  if (archetype1 === "DragNote") {
    object.noteType = 'drag'
  } else if (archetype1 === "FlickNote") {
    object.noteType = 'flick'
