...
import {
    defaultJudgeMoveYEventProperties,
    setDefaultJudgeMoveYEventProperties,
} from '../../../tools/events/judgeMoveY'
...
<template>
    <PropertiesModal :title="i18n.commands.judgeMoveYEvent.modal.title">
