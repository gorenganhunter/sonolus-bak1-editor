...
import MultiMoveYValueField from '../../../../modals/form/MultiValueField.vue'
...
const { createModel } = useSelectedEntitiesProperties(
    (entity) => entity.type === 'spawnMoveYEventJoint',
)
...
<template>
    <PropertiesModal :title="i18n.tools.events.modals.spawnMoveYEvent.title">
        <MultiMoveYValueField v-model="value" />
