...
<template>
    <FormModal
        :title="i18n.tools.events.modals.shiftEvent.title"
        @close="$emit('close')"
        @submit="$emit('close', model)"
    >
        <NumberField
            v-model="model.value"
            :label="i18n.tools.events.modals.shiftEvent.value"
            :min="0"
            :max="1"
            step="any"
            autofocus
        />
        <EaseField v-model="model.ease" :label="i18n.tools.events.modals.shiftEvent.ease" />
        <NumberField
            v-model="model.beat"
            :label="i18n.tools.events.modals.shiftEvent.beat"
            :min="0"
            step="any"
        />
    </FormModal>
